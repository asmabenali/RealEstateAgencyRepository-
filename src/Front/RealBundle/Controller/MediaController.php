...
use Front\RealBundle\Entity\Media;
use Front\RealBundle\Form\MediaType;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FrontRealBundle:Media')->findAll();

        return $this->render('FrontRealBundle:Media:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FrontRealBundle:Media:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FrontRealBundle:Media')->find($id);
        ...
        return $this->render('FrontRealBundle:Media:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FrontRealBundle:Media:edit.html.twig', array(
            'entity'      => $entity,
