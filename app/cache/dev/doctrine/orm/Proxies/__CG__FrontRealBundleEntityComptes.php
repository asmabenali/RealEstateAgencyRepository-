...
namespace Proxies\__CG__\Front\RealBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Comptes extends \Front\RealBundle\Entity\Comptes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'idCompte', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'nom', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'prenom', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'pwd', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'mail', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'tel', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'agence', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'type', '' . "\0" . 'Front\\RealBundle\\Entity\\Comptes' . "\0" . 'idOffre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Comptes $proxy) {
