...
/* FrontRealBundle:Comptes:show.html.twig */
class __TwigTemplate_e823f27a2a3b439995f0fd2585de99825a6e0dddf9f24cc11996ca7d8fbcdef4 extends Twig_Template
{
    ...
    <table class=\"record_properties\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "idCompte", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Nom</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "pwd", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Mail</th>
    ...
    <li>
        <a href=\"";
        // line 45
        echo $this->env->getExtension('routing')->getPath("comptes");
        echo "\">
            Back to the list
        </a>
    </li>
    <li>
        <a href=\"";
        // line 50
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("comptes_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "idCompte", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "FrontRealBundle:Comptes:show.html.twig";
    }
